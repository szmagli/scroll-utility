...
var org_html_manager = {
  ...
  SN_MAP: {},
  TL: null,
  HOOKS: { run_hooks: false, onShowSection: [], onReady: [] },
  setup: function() {
    var d = this
    ...
    d.LINKS +=
      (d.LINK_UP && d.LINK_UP != document.URL ? '<a href="' + d.LINK_UP + '">Up</a> / ' : "") +
      (d.LINK_HOME && d.LINK_HOME != document.URL
        ? '<a href="' + d.LINK_HOME + '">HOME</a> / '
        : "") +
    ...
    if (k.RUNS == 1 || !k.R) {
      ...
      if (null != b) {
        ...
        if (k.FIXED_TOC) {
          ...
          k.R = new OrgNode(
            null,
            k.B.getElementsByTagName("h1")[0],
            "javascript:org_html_manager.go(0);",
            0,
            null,
          )
  ...
  build: function() {
    ...
    for (var d = 0; d < this.S.length; ++d) {
      this.S[d].J = d
      var c =
        '<table class="org-info-js_info-navigation" width="100%" border="0" style="border-bottom:1px solid black;"><tr><td colspan="3" style="text-align:left;border-style:none;vertical-align:bottom;"><span style="float:left;display:inline;text-align:left;">Top: <a accesskey="t" href="javascript:org_html_manager.go(0);">' +
        f +
        '</a></span><span style="float:right;display:inline;text-align:right;font-size:70%;">' +
        this.LINKS +
        '<a accesskey="m" href="javascript:org_html_manager.toggleView(' +
        d +
        ');">toggle view</a></span></td></tr><tr><td style="text-align:left;border-style:none;vertical-align:bottom;width:22%">'
      if (d > 0) {
        c +=
          '<a accesskey="p" href="' +
          this.S[d - 1].L +
          '" title="Go to: ' +
          this.rT(this.S[d - 1].H.innerHTML) +
          '">Previous</a> | '
      } else {
        c += "Previous | "
      }
      ...
      if (0 < this.S[d].CH.length && this.LOCAL_TOC) {
        ...
        c = "Contents:<br /><ul>"
        for (var b = 0; b < this.S[d].CH.length; ++b) {
          c +=
            '<li><a href="' +
            this.S[d].CH[b].L +
            '">' +
            this.rT(this.rOT(this.S[d].CH[b].H.innerHTML)) +
            "</a></li>"
        }
        c += "</ul>"
        a.innerHTML = c
        if ("above" == this.LOCAL_TOC) {
          if (this.S[d].F) {
            ...
            this.S[d].D.insertBefore(
              a,
              this.S[d].D.getElementsByTagName("h" + this.S[d].DEPTH)[0].nextSibling,
            )
          }
        } else {
          if (this.S[d].F) {
  ...
  ss: function(d) {
    ...
    b.runHooks(e, { last: c, current: b.N })
  },
  pV: function(d, a) {
    var c = this
  ...
  warn: function(c, d, b) {
    ...
    a.CL.innerHTML =
      ...
      c +
      "</span><span style='float:right;color:#aaaaaa;font-weight:normal;'>(press any key to proceed)</span>"
    a.sC()
    window.setTimeout(function() {
  ...
  sR: function(e, b, d, a) {
    ...
    c.CL.innerHTML =
      "<span style='float:left;'>" +
      b +
      "</span><span style='float:right;color:#aaaaaa;font-weight:normal;'>(" +
      a +
      "RET to close)</span>"
    c.sC()
                                                        ...
                                                        if ("U" == c) {
                                                          ...
                                                          if ("g" == c) {
                                                            ...
                                                            if ("o" == c) {
                                                              ...
                                                              window.setTimeout(function() {
                                                                org_html_manager.CI.value =
                                                                  org_html_manager.OCCUR
                                                                org_html_manager.CI.select()
                                                              }, 100)
                                                              return
                                                            } else {
                ...
                if (a == j.RC_O) {
                  ...
                  if ("s" == h) {
                    ...
                    if ("o" == h) {
                      j.sR(
                        j.RC_NULL,
                        "Org-link, occurences of <i>&quot;" + j.OCCUR + "&quot;</i>:",
                        "[[" +
                          j.BU +
                          "?OCCUR=" +
                          j.OCCUR +
                  ...
                  if (a == j.RC_H) {
                    ...
                    if ("s" == h) {
                      ...
                      if ("o" == h) {
                        j.sR(
                          j.RC_NULL,
                          "HTML-link, occurences of <i>&quot;" + j.OCCUR + "&quot;</i>:",
                          '<a href="' +
                            j.BU +
                            "?OCCUR=" +
                            j.OCCUR +
                    ...
                    if (a == j.RC_P) {
                      ...
                      if ("s" == h) {
                        ...
                        if ("o" == h) {
                          j.sR(
                            j.RC_NULL,
                            "Plain-link, occurences of <i>&quot;" + j.OCCUR + "&quot;</i>:",
                            j.BU + "?OCCUR=" + j.OCCUR,
                            "C-c to copy, ",
                          )
                          window.setTimeout(function() {
  ...
  showTagsIndex: function() {
    ...
    if (e.Hg) {
      ...
      if (null == e.TAGS_INDEX) {
        e.TAGS_INDEX =
          'Press any key or <a href="javascript:org_html_manager.showTagsIndex();">click here</a> to proceed.<br /><br />Click the headlines to expand the contents.<h2>Index of Tags</h2>'
        for (var d = 0; d < e.ST.length; ++d) {
          ...
          for (var c = 0; c < e.TAGS[b].length; ++c) {
            var a = e.TAGS[b][c]
            e.TAGS_INDEX +=
              '<li><a href="javascript:org_html_manager.ss(' +
              a +
              ');">' +
              e.S[a].H.innerHTML +
              "</a></li>"
  ...
  removeHook: function(a, c) {
    if (this.HOOKS[a]) {
      for (var b = this.HOOKS[a].length - 1; b >= 0; --b) {
        if (this.HOOKS[a][b] == c) {
